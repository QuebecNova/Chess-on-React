import { isKeyableString, keyablePieceOnField, keyableSquares } from './../../interfaces/keyable';

export function parsePieceOnField(pieceData : keyablePieceOnField, squares : keyableSquares) : keyablePieceOnField {
