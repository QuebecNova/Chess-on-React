...
import { isMated } from "../services/board/checkAndMateHandler"
import { stopAllTimers } from "../services/updatePlayerTime"
import { playerWhite, playerBlack } from '../components/board components/DefineSide';

export function useMated(squares : keyableSquares, turn : string) : [boolean, boolean] {
